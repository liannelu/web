            ...
            <div class="row">
                <div class="col-md-12 col-sm-8 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                            <h2>Top 1 Disease/Diagnosis per Barangay<small>Graph</small></h2>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary " name="generateBtn" value="barangayChart" style="margin-top: 4px;">Generate Report</button>
                        ...
                        <div class="x_panel">
                            <div class="x_content">     
                                ...
                                <%}%>
                                <canvas id="barangayChart" width="400" height="150"></canvas>
                            </div><!--x_content-->
                            </div>
                        </div><!--x_panel-->
                </div><!--col-md-4-->
                ...
                var chart1 = new Chart(document.getElementById('barangayChart').getContext('2d'), {
                    ...
                    data: {
                        labels: [<%
                                ...
                                list = chartsDAO.topDiseaseBarangayAll2(tempYear);
