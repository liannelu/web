...
<body onload="window.print();"> <!-- FOR PRINTING-->
<body class="nav-md">
...
<div class="wrapper" role="main">
    ...
    <!-- FOR PRINTING-->
    <!--Removed right_col edited-->
    <!--Removed breadcrumb-->
    <!--Removed right_col edited-->
    <!--Removed the header ung selection ng date and print buttons-->
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
       ...
       <div class="x_content">
        ...
        <table class="table table-bordered table-condensed" cellpadding="1" border="1" width="100%">
            <tr height="30">
                <td width="15%"><img src="images/dohreportlogo.jpg" height="80" /></td>
                <td width="" align="center">
                    ...
                    CATCHMENT HEALTH CENTER: <b>RURA HEALTH UNIT I</b>   
                    </h5>
                </td>
                <td width="15%"><img src="images/m2logoreport2.jpg" height="90" /></td>
            </tr>
        </table>
        ...
        <table class="table table-bordered table-condensed" cellpadding="1" border="1" width="100%">
           ...
           <thead class="text-center">
            <tr style="background-color: #f2f2f2" align="center">
                <td rowspan="3"><strong>Name of Diagnosis</strong></td>
       ...
       <div class="form-group row">
            ...
            <div class="col-md-2">
               <div class="row"> 
                ...
                <div class="row">
                  <div class="col-md-8">
                    <b><%=currentUser.getFullname()%></b>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-8">
                  <p style="font-style: italic;">
                       <% if (currentUser.getPosition().equalsIgnoreCase("physician")){
                           out.println("Head Physician - RHU I");
                       }else{
                           out.println(currentUser.getBarangay() + currentUser.getPosition());
                       } %>
                  </p>
                  </div>
                </div>
