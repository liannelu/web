        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="home_doctor.jsp" class="site_title"><i class="fa fa-stethoscope"></i> <span>PBIS</span></a>
            </div>
            ...
            <div class="profile clearfix">
              <div class="profile_pic">
                <img src="images/doctor.png" alt="..." class="img-circle profile_img">
              </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  <li><a href=home_doctor.jsp><i class="fa fa-home"></i> Home </a>
                  </li>
                  ...
                  <li><a><i class="fa fa-file-text-o"></i>Reports &amp; Analytics<span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="manage_diseases.jsp">Manage Diagnosis</a></li>
              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/doctor.png" alt=""><%=currentUser.getUsername() %>
