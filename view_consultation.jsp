                                ...
                                <!--KAPAG LALAKE-->   
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <textarea class="form-control noresize" cols="10" rows="5" name="complaintsOfPatient" disabled><%=selectedCons.getChief_complaints()%></textarea>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-md-3">
                                            ...
                                            <input disabled class="form-control" id="nameProvider" name="nameProvider" type="text" value=" <%=nDAO.retrieveUser(selectedCons.getAdded_by()).getFullname()%> ">
                                        </div>
                                    </div>
                                    <!--form-group-row-->
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control noresize" cols="10" rows="5" name="diagnosisRemarks" disabled><%=selectedCons.getRemarks()%></textarea>
                                            </div>
