  ...
  <body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <div class="row">
            <div class="col-md-12 col-sm-8 col-xs-12">
                <div class="x_panel ">
                    ...
                    <div class="x_title">
                        <h2>Disease/Diagnosis per Barangay Chart <small>Graph</small></h2>
                    ...
                    <div class="x_content">
                            ...
                            <div class="row">
                                 <div class="col-md-3">
                                    <label for="example-month-input">Year</label>
                            ...
                            <!-- DIAGNOSIS PICKER -->
                                <div class="col-md-3">
                                    <label for="diagniosis1">Disease/Diagnosis:</label>
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                ...
                                <div class="col-12">
                                    <button type="submit" class="btn btn-primary " name="generateBtn" value="diseasePerBarangayChart" style="margin-top: 4px;">Generate Report</button>
                    ...
                    <div class="x_panel">
                        <div class="x_content">   
                                ...
                                <%if(session.getAttribute("diseaseChartDiagnosis1") != null && session.getAttribute("chartYear") != null){
                                ...
                                <%}%>
                            <canvas id="diseasePerBarangayChart" width="400" height="150"></canvas>
                        </div><!--x_content-->
                    </div><!--x_panel-->
        ...
        function diseasePerBarangayChart(){
                var chart1 = new Chart(document.getElementById('diseasePerBarangayChart').getContext('2d'), {
                    ...
                    data: {
                        labels: [<%
                                ...
                                if(session.getAttribute("chartYear") != null && session.getAttribute("diseaseChartDiagnosis1") != null){
                                    tempYear = (Integer) session.getAttribute("chartYear");
                                    tempDiagnosis = (Integer) session.getAttribute("diseaseChartDiagnosis1");
                                }
                                list = chartsDAO.diseasePerBarangayChart(tempDiagnosis, tempYear);
                                for(int i = 0; i < list.size(); i++){
                                    out.print("\"");
                                    out.print(list.get(i).getBarangay() + "\""+",");
                                } 
