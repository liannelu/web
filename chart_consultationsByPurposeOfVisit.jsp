  ...
  <body class="nav-md">
    ...
    <div class="container body">
      <div class="main_container">
        ...
        <!-- CONSULTATIONS BY PURPOSE OF VISIT -->  
        <div class="row">
            <div class="col-md-12 col-sm-8 col-xs-12">
                <div class="x_panel">
            
                    <div class="x_title">
                        <h2>Consultations by Purpose of Visit <small>Graph</small></h2>
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary " name="generateBtn" value="consultationsByPurposeOfVisit" style="margin-top: 4px;">Generate Report</button>
                    ...
                    <div class="x_panel">
                        <div class="x_content">
                            ...
                            <%}%>
                            <canvas id="consultationsByPurposeOfVisitChart" width="400" height="150"></canvas>
                        </div><!--x_content-->
                    </div>
                </div><!--x_panel-->
            </div><!--col-md-4-->
    ...
    <script>
        ...
        function consultationsByPurposeOfVisitChart(){//consultations by purpose of visit
            var chart1 = new Chart(document.getElementById('consultationsByPurposeOfVisitChart').getContext('2d'), {
                ...
                data: {
                    labels: [<%
                            ...
                            list3 = chartsDAO.consultationsByPurposeOfVisit(tempYear, tempBarangay);
        ...
        <%
            if(session.getAttribute("chartYear") != null && session.getAttribute("chartBarangay") != null){%>
            <script>
                  consultationsByPurposeOfVisitChart();
                </script>
            <%}        
          %>
