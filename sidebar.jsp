        ...
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="home.jsp" class="site_title"><i class="fa fa-stethoscope"></i> <span>PBIS</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <h3>ROOT USER SIDEBAR</h3>
                <ul class="nav side-menu">
                  <li><a href=home.jsp><i class="fa fa-home"></i> Home </a>
                  </li>
                  
                    
                    <li><a><i class="fa fa-pencil-square-o"></i> Today View <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="view_acknowledgements_today.jsp">Acknowledgements for Today</a></li>
                  ...
                  <li><a><i class="fa fa-pencil-square-o"></i> Records <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="view_family_codes.jsp">View Family Numbers</a></li>
                        ...
                        <li><a href="view_pending_acknowledgements.jsp">View Consultations Pending Acknowledgements</a></li>
                    </ul>
                  </li>
                  
                  <li><a><i class="fa fa-file-text-o"></i>Standard Reports <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="reportM1.jsp">M1</a></li>
                      <li><a href="reportM2.jsp">M2</a></li>
                      <li><a href="view_standard_reports.jsp">Standard Reports</a></li>
<!--                      <li><a href="view_custom_reports.jsp">Custom Reports</a></li>-->
                    </ul>
                  </li>
                  ...
                  <li><a><i class="fa fa-bar-chart"></i> Analytics <span class="fa fa-chevron-down"></span></a>
                        ...
                        <li><a href="view_programs.jsp">View Programs</a></li>
                            <li><a>Temporary<span class="fa fa-chevron-down"></span></a>
                          <ul class="nav child_menu">
                            <li class="sub_menu">
                              <li><a href="program_planning_without_disease.jsp">Program Proposal</a></li>
                              <li><a href="program_evaluation.jsp">Program Evaluation</a></li>
                              <li><a href="view_programs.jsp">View Programs</a></li>
                              <li><a href="manage_diseases.jsp">Manage Diseases</a></li>
                          </ul>
                        </li>
                        </li>
                    </ul>
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="images/img.jpg" alt=""><%=currentUser.getUsername() %>
