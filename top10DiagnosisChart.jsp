            ...
            <div class="row">
                <div class="col-md-7 col-sm-8 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_title">
                            <h2>Top 10 Diseases RHU <small>Graph</small></h2>
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn-primary " name="generateBtn" value="top10DiagnosisChart" style="margin-top: 4px;">Generate Disease Report</button>
                            </div>
                        </div>
                        ...
                        <div class="x_panel">
                            <div class="x_content">     
                                ...
                                <%}%>
                                <canvas id="top10DiagnosisChart" width="400" height="400"></canvas>
                            </div><!--x_content-->
                            </div>
                        </div><!--x_panel-->
                </div><!--col-md-4-->
