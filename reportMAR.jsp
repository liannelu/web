...
<div class="right_col edited fix" role="main">
   ...
   <ol class="breadcrumb">
        ...
        <%}%>
            ...
            <li class="breadcrumb-item active">MAR</li>
        </ol>
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <form action="ReportM2" post="post">
         ...
         <div class="x_panel">
              <div class="x_content">
                ...
                <h4 class="card-title">Monthly Accomplishment Report</h4>
        ...
        <div class="x_panel">
            ...
            <div class="x_title">
            <h2><i class="fa fa-bars"></i> MAR <small>Monthly Accomplishment Report</small></h2>
            ...
            <table class="table table-bordered table-condensed" cellpadding="1" border="1" width="100%">
                <tr height="30">
                    <td width="" align="center">
                        <h2 style="font-size:20px; padding:5px; margin:0px;color:#1a7202;font-family:tahoma;  ">MONTHLY ACCOMPLISHMENT REPORT</h2>
                        <p style="font-size:14px; font-style: italic">City Health Office</p>
                        <p style="font-size:14px; font-style: italic">City of San Fernando</p>
